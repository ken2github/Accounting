...
// }
//
// public FileReadyOnlyTransactionList(InputStream io, String nominalCount,
// List<Date> nominalMonths,
// String fileName) {
// super();
...
// String.format("The count '%s' is not mapped on any FormatReader",
// nominalCount)));
...
// "Got unexpected exception when reading from InputStream. Exception : '%s'.
// Stacktrace : '%s'", e,
...
// }
//
// private void loadTransactionList(InputStream io, String nominalCount,
...
// String sectorName =
// transactionStrings[NORMALIZED_FIELD_POSITION_OF.SECTOR.ordinal()];
// String title =
// transactionStrings[NORMALIZED_FIELD_POSITION_OF.TITLE.ordinal()];
...
// 2);
// Date date =
// parseDate(transactionStrings[NORMALIZED_FIELD_POSITION_OF.DATE.ordinal()]);
// transactions.add(new
// Transaction().setAmount(amount).setIsCommon(isCommon).setCountName(countName)
...
// throw new ApiException(new ApiError(HttpStatus.INTERNAL_SERVER_ERROR,
// ApiErrorCode.INTERNAL_ERROR,
// String.format("Error in parsing date '%d' with format \"yyyy-MM-dd\"", date),
// e.getMessage()));
// }
//
// }
...
// t.getDate()).sorted().collect(Collectors.toList());
// }
//
// @Override
...
// return (hasTransactions()) ? transactions.stream().map(t ->
// t.getDate()).min(Date::compareTo).get() : null;
// }
//
// @Override

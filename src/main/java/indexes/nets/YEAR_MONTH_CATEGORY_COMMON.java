...
public class YEAR_MONTH_CATEGORY_COMMON extends MapIndex {
	...
	private static Class<? extends MapIndex> getMyClass(){
		return YEAR_MONTH_CATEGORY_COMMON.class;
	}
	...
	private static Map<String,Double> computeYearIndex(YearBook yb) {
		...
		for (String key : depMap.keySet()) {
			...
			String id = Utils.delimiterizing(year,month,category,common);

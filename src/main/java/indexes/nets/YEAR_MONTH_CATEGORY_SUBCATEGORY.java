...
public class YEAR_MONTH_CATEGORY_SUBCATEGORY extends MapIndex {
	...
	private static Class<? extends MapIndex> getMyClass(){
		return YEAR_MONTH_CATEGORY_SUBCATEGORY.class;
	}
	...
	private static Map<String,Long> computeYearIndex(YearBook yb) {
		...
		for (String key : depMap.keySet()) {
			...
			String id = Utils.delimiterizing(year,month,category,subcategory);

...
public class Internal_2_0_XLS_Reader extends AbstractXLSReader {
	...
	public Internal_2_0_XLS_Reader(InputStream is) {
				...
				for (int c = 0; c < cols; c++) {
					...
					if (cell != null) {
						...
						case 0: // data
							...
							// .valueOfDateFromString(cell.getDateCellValue(), "dd-MM-yyyy");
							break;
						case 1: // importo

...
public class BankTransactionAnalyser2 implements TransactionsOracle {
	...
	@Override
	public List<String> suggestSectorsForTransaction(Transaction transaction, int maxResults,
	...
	private double thresholdRelevance(SimilarityRelevance relevance) {
		switch (relevance) {
		case HIGH:
			return 0.9d;
		case MEDIUM:
